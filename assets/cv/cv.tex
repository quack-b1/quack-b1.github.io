...
\headleft{About Me}
BSc (Hons) Computer Science student at Lancaster University in Leipzig, Germany. Passionate about technology, leadership, and innovation. 
...
\jobtitle{Camp Counselor}  \location{Germany} \\
\textsc{Oskar Lernt Englisch}  \dates{Jul 2026--Present} \\
\small{Camp counselor teaching English, delivering workshops, and supervising activities on a freelance basis.}

\is
\jobtitle{Aushilfe F\&B}  \location{Leipzig, Germany} \\
\textsc{Radisson Hotel Leipzig}  \dates{Jan 2026--Present} \\
\small{Numerous tasks in breakfast, restaurant, and bar on a casual-worker basis}
...
\smaller{Troubleshot Microsoft Azure policy conflicts \& set up new-hire devices} 
...
\jobtitle{Lancaster University}  \location{Leipzig, Germany}\\
\normalsize{Computer Science, Bachelor of Science (Hons)} \dates{Oct 2025--Present}\\

\jobtitle{Gisma University of Applied Sciences}  \location{Berlin, Germany}\\
\normalsize{Computer Science, Bachelor of Science} \dates{Oct 2024--June 2025}\\
\small{Grade: 1,5 (Sehr Gut),  45 ECTS} 
